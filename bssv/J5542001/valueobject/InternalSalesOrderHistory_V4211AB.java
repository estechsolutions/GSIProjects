 ...
 */
public class InternalSalesOrderHistory_V4211AB extends ValueObject implements Serializable {

    private InternalSelectWhereFields queryWhereFields = new InternalSelectWhereFields();
    ...
    public void setQueryWhereFields(InternalSelectWhereFields queryWhereFields) {
        this.queryWhereFields = queryWhereFields;
    }

    public InternalSelectWhereFields getQueryWhereFields() {
    ...
    public InternalSelectResults getQueryResults(int i){
        if (this.queryResults != null && this.queryResults.size()>i){
            return (InternalSelectResults)queryResults.get(i);
        }else{
            return null;
        }
    }
